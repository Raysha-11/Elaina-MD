...
let handler = async (m, { conn }) => {
  ...
  conn.sendButton(m.chat, `Dashboard *${conn.user.name}*\n\n${txt}`, wm, await( await fetch(global.thumb)).buffer(), [['Test speed', `.speed`], ['Owner', '.owner']],m, fakeig)
}
handler.help = ['dashboard']
handler.tags = ['info']
handler.command = /^(dashboard|db)$/i
